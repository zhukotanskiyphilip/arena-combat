...
- [x] 3D rendering (wgpu) - базовий renderer готовий
- [x] FPS counter в заголовку вікна
- [ ] Camera controller
- [ ] 3D модель манекена
- [ ] Fluid movement (WASD)
- [ ] Directional attacks
...
- *(WASD, миша - буде додано в наступних сесіях)*

### Поточні features:
- Вікно 800x600 з wgpu renderer
- Темно-синій clear color (placeholder для 3D сцени)
- FPS counter в заголовку (оновлюється кожні 30 кадрів)
- GPU: автовибір Vulkan/DX12/Metal backend
...
**Прогрес:** Сесія 4 завершена - wgpu renderer + FPS counter працюють!
